...
TREASURY_ADDRESS = "0x1231231231231231231231231231231231231231"
AIRDROP_EXPIRES_AT = int(time.time()) + 60 * 60 * 24 * 7  # 7 days
...
@pytest.fixture(scope="session")
def airdrop_expires_at():
    return AIRDROP_EXPIRES_AT
